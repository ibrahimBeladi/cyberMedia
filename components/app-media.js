Vue.component("app-media", {
    ...
    data: function () {
        return {
            links: [
                { code: "media.crimeLaws", icon: "mdi-security", href: "http://www.citc.gov.sa/en/RulesandSystems/CITCSystem/Documents/LA_004_%20E_%20Anti-Cyber%20Crime%20Law.pdf" },
                { code: "media.presentation", icon: "mdi-presentation-play", href: "//google.com" },
                { code: "media.infographic", icon: "mdi-camcorder-box", href: "//google.com" },
            ]
        }
    },
    computed: {
